...
public:
    int largestNum();
    void smallestIndex(int& smallestInd);
...
template <class elemType>
void arrayListType<elemType>::smallestIndex(int& smallestInd){
    int smallestIndex = 0;
    for (int i = 0; i <= this->length;i++){
    ...
    smallestInd = smallestIndex;
}
template <class elemType>
int arrayListType<elemType>::largestNum(){
